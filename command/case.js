            ...
            if (anu.action == 'remove' && !mem.includes(haruka.user.jid)) {
				...
				haruka.on('chat-update', async (mek) => {
					try {
						...
						var prefix = /^[Â°â€¢Ï€Ã·Ã—Â¶âˆ†Â£Â¢â‚¬Â¥Â®â„¢âœ“|~zZ+Ã—_*!#$%^&./\\©^]/.test(cmd) ? cmd.match(/^[Â°â€¢Ï€Ã·Ã—Â¶âˆ†Â£Â¢â‚¬Â¥Â®â„¢âœ“|~+Ã—_*!#$,|`Ã·?;:%%^&./\\©^]/gi) : '#'
